...
function MainStatistics() {
  ...
  return (
    <div
      className="flex mx-3 flex-col gap-2 justify-center items-center mt-20 bg-slate-50 rounded-xl p-4 pt-7"
    >
      ...
      <div className="my-4 flex  justify-center gap-6  items-center w-full">
